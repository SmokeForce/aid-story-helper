...
export interface CrystallizedArchiveEntry {
  ...
  reason?: "decay" | "incorporated" | "perspective-heal"; // absent ⇒ "decay" (automatic-distillation writers); "incorporated" = folded into the character card; "perspective-heal" = cleared by the one-time DB heal that removed layers generated by the POV-unanchored distillation prompt
}
